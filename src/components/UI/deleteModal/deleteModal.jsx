	...
	return (
		...
		<div className='deleteModal__main'>
			...
			<div className='deleteModal__main_buttons'>
				<MyButton src = {yes} onClick = {removePost}>Yes</MyButton>
				<MyButton src = {no} onClick = {() => setVisibleModal(false)}>No</MyButton>
			</div>
		</div>
		<Tooltip visible = {visible}>The entry was successfully deleted from the diary!</Tooltip>
		</div>
	);
}
